...
::: {.column width="15%" style="font-size: 60%; display: flex; align-items: center; justify-content: center;"}
-   Most distinct trends related to individual states, rather than time
...
::: {.column width="15%" style="font-size: 60%; display: flex; align-items: center; justify-content: center;"}
-   **Overall overdose deaths** trend closely match of **synthetic opioid overdose** deaths trend
-   **Synthetic opioid overdose deaths** make up **majority of total drug overdose deaths** each period
:::
:::::
...
-   US overdose deaths from [all drugs]{.underline} & [synthetic opioids]{.underline} *in 12 month periods* increased from 2016 to 2023 (then decrease from 2023-2025)
